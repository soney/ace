...
(function(){
    ...
    this.navigateUp = function(times) {
		if(this.session.livedoc) {
			if(this.session.livedoc.claim_key("up")) {
				return;
			}
		}
    ...
    this.navigateDown = function(times) {
		if(this.session.livedoc) {
			if(this.session.livedoc.claim_key("down")) {
				return;
			}
		}
        this.selection.clearSelection();
    ...
    this.navigateLeft = function(times) {
		if(this.session.livedoc) {
			if(this.session.livedoc.claim_key("left")) {
				return;
			}
		}
    ...
    this.navigateRight = function(times) {
		if(this.session.livedoc) {
			if(this.session.livedoc.claim_key("right")) {
				return;
			}
		}
        if (!this.selection.isEmpty()) {
